...
public class ApiService {
   final String API = "https://jimmyflag.azurewebsites.net/findFlag"; // find ud  af, hvilket IP + port
   // final String API = "https://localhost:80/findFlag"; // find ud  af, hvilket IP + port
